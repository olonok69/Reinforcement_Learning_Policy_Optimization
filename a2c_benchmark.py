...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run A2C benchmark on CartPole-v1")
    ...
    parser.add_argument("--video-dir", default="videos/a2c", help="Directory for recorded videos")
...
if __name__ == "__main__":
    ...
    _, result = run_timed(lambda: run_a2c(config), "A2C")
    print("\n--- Summary ---")
